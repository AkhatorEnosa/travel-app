  ...
  return (
    <section className='max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 lg:flex-row'>
      ...
      <div className='relative z-20 flex flex-1 flex-col lg:w-1/2'>
        ...
        <div className='flex flex-col lg:flex-row w-full gap-3 sm:flex-row'>
            <Button 
              type="button" 
              title="Download App" 
              variant="btn_green"/>
      ...
      <div className='relative flex flex-1 items-start'>
            <div className='relative flex x-20 w-[268px] flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8'>
